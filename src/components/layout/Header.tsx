...
export function Header() {
  ...
  const searchResults = useMemo<SearchResultItem[]>(() => {
    const pageItems: SearchResultItem[] = [
      ...
      { id: 'page-ai-coach', kind: 'page', title: isTurkish ? 'YZ Koçu' : 'AI Coach', subtitle: isTurkish ? 'Koçluk soruları ve eylem planı' : 'Coaching prompts and action plans', route: '/ai', keywords: 'yz koç ai coach motivasyon motive teşvik koçluk ekip plan aksiyon ai motivation inspire coaching' },
