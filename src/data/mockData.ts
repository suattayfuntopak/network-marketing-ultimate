...
export const pipelineStages: PipelineStageConfig[] = [
  ...
  { stage: 'presentation_sent', label: 'Sunum Gönderildi', color: '#14b8a6', order: 5, probability: 50, requiredActions: ['Sunum linkini paylas'], automationTriggers: ['presentation_reminder_24h'] },
  { stage: 'presentation_done', label: 'Sunum Yapıldı', color: '#f97316', order: 6, probability: 55, requiredActions: ['Takip planla'], automationTriggers: ['auto_followup_48h'] },
  { stage: 'followup_pending', label: 'Takip Ediliyor', color: '#f59e0b', order: 7, probability: 60, requiredActions: ['Takip iletişimi kur'], automationTriggers: ['reminder_24h'] },
  { stage: 'objection_handling', label: 'İtiraz Yönetimi', color: '#f97316', order: 8, probability: 65, requiredActions: ['İtirazları etiketle', 'Yanıt gönder'], automationTriggers: [] },
  { stage: 'ready_to_buy', label: 'Karar Aşamasında', color: '#22c55e', order: 9, probability: 80, requiredActions: ['Siparişi işle'], automationTriggers: ['auto_order_followup'] },
  { stage: 'became_customer', label: 'Müşteri', color: '#10b981', order: 10, probability: 100, requiredActions: ['Karşılama sekansı', 'Yeniden sipariş hatırlatması ayarla'], automationTriggers: ['customer_onboarding'] },
  { stage: 'ready_to_join', label: 'Katılmaya Hazır', color: '#a855f7', order: 11, probability: 85, requiredActions: ['Kayıt işlemini gerçekleştir'], automationTriggers: [] },
  { stage: 'became_member', label: 'Ekip Üyesi', color: '#d946ef', order: 12, probability: 100, requiredActions: ['Oryantasyon akışını başlat'], automationTriggers: ['member_onboarding'] },
  { stage: 'nurture_later', label: 'Sonra İlgilen', color: '#94a3b8', order: 13, probability: 10, requiredActions: ['Gelecek hatırlatma ayarla'], automationTriggers: ['nurture_sequence'] },
  { stage: 'dormant', label: 'Pasif', color: '#6b7280', order: 14, probability: 5, requiredActions: [], automationTriggers: ['reactivation_30d'] },
  { stage: 'lost', label: 'Kaybedildi', color: '#ef4444', order: 15, probability: 0, requiredActions: [], automationTriggers: [] },
]
